...
import {deleteBookingAction, fetchBookings} from "@/actions/action";
                    ...
                    {bookings.map((booking) => {
                        ...
                        return (
                          <TableRow key={id}>
                            ...
                            </TableCell><TableCell>{totalNights}</TableCell><TableCell>{formatCurrency(orderTotal)}</TableCell>
